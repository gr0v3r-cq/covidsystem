...
Route::group(['prefix' => 'admin', 'middleware'=> 'auth'],function(){
	...
	Route::resource('/datacov', 'Admin\DatacovController',['as' => 'admin']);
	...
	// Route::resource('/publications', 'Admin\PublicationsController',['as' => 'admin']);
	// Route::resource('/covers', 'Admin\CoversController',['as' => 'admin']);
});
